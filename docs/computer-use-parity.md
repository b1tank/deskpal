...
| Semantic element discovery/action | Native app accessibility integration | Bounded AT-SPI inspection plus capture-bound press/toggle, text, numeric value, and direct-child selection mutation without pointer/keyboard/clipboard fallback | Partial parity |
