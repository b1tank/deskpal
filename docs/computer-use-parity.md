...
| Semantic element discovery/action | Native app accessibility integration | Bounded AT-SPI inspection, capture-bound press/toggle, text mutation, and numeric value mutation without pointer/keyboard/clipboard fallback | Partial parity |
