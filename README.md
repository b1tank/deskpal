...
For accessible controls, `deskpal_agent_semantic_press` connects a stable app
observation, logical-cursor motion, verified AT-SPI invocation, and an explicit
postcondition without shared-pointer fallback; see
